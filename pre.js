function() {
	/* LOAD GEOJSON MAP & INTEGRATE SHAPE DATA */
	/*
	...
	**/
	var getResource = 
		this.dashboard.getWebAppPath() + '/plugin/pentaho-cdf-dd/api/resources';
